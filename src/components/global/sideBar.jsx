...
export const SideBar = () => {
    ...
    const normalNav = <nav className="w-[226px] h-full border-[1px] border-gray-300 rounded-r-[45px] pt-9 flex flex-col justify-between">
        ...
        <div className="px-7">
            <div className="rounded-[20px] bg-rose-opacity px-4 pt-[42px] pb-4 border-[1px] border-rose-700 flex flex-col gap-2">
                <h1 className="text-lg font-semibold text-gray-700">Play movie quizes and earn free tickets</h1>
    ...
    const mobileNav = <nav className="bg-white fixed h-[66px] w-full py-2 px-4 flex border-b-[1px] border-rose-600 items-center justify-between z-[100]">
