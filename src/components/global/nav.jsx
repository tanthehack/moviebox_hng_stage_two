...
export const Nav = () => {
    ...
    const normalNav = <nav className="flex items-center justify-between w-full text-white py-6 px-24">
    ...
    const mobileNav = <nav className="flex items-center justify-between w-full text-white p-6 relative h-[70px]">
